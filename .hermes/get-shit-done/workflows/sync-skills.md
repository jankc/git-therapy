...
INSTALL_JS_GLOBAL="/Users/jank/dev/personal/git-therapy/.hermes/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/jank/dev/personal/git-therapy/.hermes/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
