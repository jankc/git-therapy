...
`./.hermes/skills/spike-findings-[project]/` (project-local) and summary to
...
3. Check if `./.hermes/skills/spike-findings-*/SKILL.md` exists for this project
...
2. The skill will be created at `./.hermes/skills/spike-findings-[project-dir-name]/`
...
**Feature areas:** [list]
**Skill output:** `./.hermes/skills/spike-findings-[project]/`
...
## Update Project HERMES.md

Add an auto-load routing line to the project's HERMES.md (create the file if it doesn't exist):
...
- [ ] Spike-findings skill exists at `./.hermes/skills/` with SKILL.md (including requirements), references/, sources/
...
- [ ] Project HERMES.md has auto-load routing line
- [ ] Summary presented
