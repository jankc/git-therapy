...
<required_reading>
@/Users/jank/dev/personal/git-therapy/.hermes/get-shit-done/references/ai-frameworks.md
@/Users/jank/dev/personal/git-therapy/.hermes/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/jank/dev/personal/git-therapy/.hermes/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/jank/dev/personal/git-therapy/.hermes/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/jank/dev/personal/git-therapy/.hermes/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/jank/dev/personal/git-therapy/.hermes/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/jank/dev/personal/git-therapy/.hermes/agents/gsd-eval-planner.md for instructions.
