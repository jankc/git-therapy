...
- **Global scope**: `/Users/jank/dev/personal/git-therapy/.hermes/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/jank/dev/personal/git-therapy/.hermes/notes/`)
...
2. Glob `/Users/jank/dev/personal/git-therapy/.hermes/notes/*.md` (if directory exists) — global notes
...
Global (/Users/jank/dev/personal/git-therapy/.hermes/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/jank/dev/personal/git-therapy/.hermes/notes/` — works in any directory
