...
```bash
if [ "$RUNTIME" = "codex" ]; then INSTRUCTION_FILE="AGENTS.md"; else INSTRUCTION_FILE="HERMES.md"; fi
```
...
SPIKE_SKILL=$(ls ./.hermes/skills/spike-findings-*/SKILL.md 2>/dev/null | head -1 || true)

# Check for sketch findings skill (project-local)
SKETCH_SKILL=$(ls ./.hermes/skills/sketch-findings-*/SKILL.md 2>/dev/null | head -1 || true)
...
Use template: /Users/jank/dev/personal/git-therapy/.hermes/get-shit-done/templates/research-project/STACK.md
</output>
...
Use template: /Users/jank/dev/personal/git-therapy/.hermes/get-shit-done/templates/research-project/FEATURES.md
</output>
...
Use template: /Users/jank/dev/personal/git-therapy/.hermes/get-shit-done/templates/research-project/ARCHITECTURE.md
</output>
...
Use template: /Users/jank/dev/personal/git-therapy/.hermes/get-shit-done/templates/research-project/PITFALLS.md
</output>
...
Use template: /Users/jank/dev/personal/git-therapy/.hermes/get-shit-done/templates/research-project/SUMMARY.md
...
- `.planning/ROADMAP.md`
- `.planning/STATE.md`
- `$INSTRUCTION_FILE` (`AGENTS.md` for Codex, `HERMES.md` for all other runtimes)
...
- [ ] `$INSTRUCTION_FILE` generated with GSD workflow guidance (AGENTS.md for Codex, HERMES.md otherwise)
