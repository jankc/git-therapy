...
UI implementation. Reads from `.planning/sketches/`, writes skill to `./.hermes/skills/sketch-findings-[project]/`
...
3. Check if `./.hermes/skills/sketch-findings-*/SKILL.md` exists for this project
...
Derive from the project directory name: `./.hermes/skills/sketch-findings-[project-dir-name]/`
...
**Design areas:** [list]
**Skill output:** `./.hermes/skills/sketch-findings-[project]/`
...
**Design areas:** {list}
**Skill:** `./.hermes/skills/sketch-findings-[project]/`
...
- [ ] Sketch-findings skill exists at `./.hermes/skills/` with SKILL.md, references/, sources/
