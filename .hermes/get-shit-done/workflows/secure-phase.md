...
```
Agent(
  prompt="Read /Users/jank/dev/personal/git-therapy/.hermes/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/jank/dev/personal/git-therapy/.hermes/get-shit-done/templates/SECURITY.md`
