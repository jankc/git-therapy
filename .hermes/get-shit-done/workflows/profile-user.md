...
Key references:
- @/Users/jank/dev/personal/git-therapy/.hermes/get-shit-done/references/ui-brand.md (display patterns)
- @/Users/jank/dev/personal/git-therapy/.hermes/agents/gsd-user-profiler.md (profiler agent definition)
- @/Users/jank/dev/personal/git-therapy/.hermes/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/Users/jank/dev/personal/git-therapy/.hermes/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/Users/jank/dev/personal/git-therapy/.hermes/get-shit-done/USER-PROFILE.md" "/Users/jank/dev/personal/git-therapy/.hermes/USER-PROFILE.backup.md"
```
...
Your recent Hermes Agent sessions, looking for patterns in these
...
✓ Stores profile at /Users/jank/dev/personal/git-therapy/.hermes/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `/Users/jank/dev/personal/git-therapy/.hermes/get-shit-done/references/user-profiling.md`
...
Reference: @/Users/jank/dev/personal/git-therapy/.hermes/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to /Users/jank/dev/personal/git-therapy/.hermes/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "HERMES.md profile section" -- "Add profile to this project's HERMES.md"
  - "Global HERMES.md" -- "Add profile to /Users/jank/dev/personal/git-therapy/.hermes/HERMES.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /Users/jank/dev/personal/git-therapy/.hermes/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /Users/jank/dev/personal/git-therapy/.hermes/skills/gsd-dev-preferences/SKILL.md"

**For HERMES.md profile section (if selected):**

```bash
gsd_run query generate-claude-profile --analysis "$ANALYSIS_PATH" --json
```

Display: "✓ Added profile section to HERMES.md"

**For Global HERMES.md (if selected):**

```bash
gsd_run query generate-claude-profile --analysis "$ANALYSIS_PATH" --global --json
```

Display: "✓ Added profile section to /Users/jank/dev/personal/git-therapy/.hermes/HERMES.md"
...
```bash
BACKUP_PATH="/Users/jank/dev/personal/git-therapy/.hermes/USER-PROFILE.backup.md"
```
...
Your profile:    /Users/jank/dev/personal/git-therapy/.hermes/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /Users/jank/dev/personal/git-therapy/.hermes/skills/gsd-dev-preferences/SKILL.md
  ✓ HERMES.md section       ./HERMES.md
  ✓ Global HERMES.md        /Users/jank/dev/personal/git-therapy/.hermes/HERMES.md
```
