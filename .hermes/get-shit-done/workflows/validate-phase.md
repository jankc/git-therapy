...
```
Agent(
  prompt="Read /Users/jank/dev/personal/git-therapy/.hermes/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/jank/dev/personal/git-therapy/.hermes/get-shit-done/templates/VALIDATION.md`
