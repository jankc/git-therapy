...
//      location across all runtimes (Hermes Agent, Codex, OpenCode, etc.).
//
...
const EFFORT_RENDERING = {
  // Hermes Agent subagent effort: output_config.effort frontmatter key /
...
//
// Hermes Agent has NO per-subagent fast-mode mechanism — /fast is a session-level
