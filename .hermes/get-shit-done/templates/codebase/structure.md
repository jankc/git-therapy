...
**commands/gsd/**
- Purpose: Slash command definitions for Hermes Agent
...
- `HERMES.md` - Instructions for Hermes Agent when working in this repo
...
- Usage: Reference from command with `@/Users/jank/dev/personal/git-therapy/.hermes/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/jank/dev/personal/git-therapy/.hermes/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/jank/dev/personal/git-therapy/.hermes/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
