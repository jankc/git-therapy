...
// Windows/Git Bash, or slow Hermes Agent piping during large outputs),
// exit silently instead of hanging until Hermes Agent kills the process
  ...
  try {
    ...
    if (isCritical && isGsdActive && !warnData.criticalRecorded) {
      try {
        ...
        // Using __dirname makes this work on Hermes Agent, OpenCode, Gemini,
        // Kilo, etc. without hardcoding ~/.hermes/.
