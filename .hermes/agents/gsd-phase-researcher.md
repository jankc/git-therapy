...
**HERMES.md enforcement:** If `./HERMES.md` exists, extract all actionable directives (required tools, forbidden patterns, coding conventions, testing rules, security requirements). Include a `## Project Constraints (from HERMES.md)` section in RESEARCH.md listing these directives so the planner can verify compliance. Treat HERMES.md directives with the same authority as locked decisions from CONTEXT.md — research should not recommend approaches that contradict them.
</project_context>
...
@/Users/jank/dev/personal/git-therapy/.hermes/get-shit-done/references/thinking-models-research.md
...
```bash
node "/Users/jank/dev/personal/git-therapy/.hermes/get-shit-done/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
