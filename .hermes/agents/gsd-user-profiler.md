...
<reference>
@/Users/jank/dev/personal/git-therapy/.hermes/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/jank/dev/personal/git-therapy/.hermes/get-shit-done/references/user-profiling.md` to load:
