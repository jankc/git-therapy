...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/jank/dev/personal/git-therapy/.opencode/.gsd-surface.json`
(sibling to `/Users/jank/dev/personal/git-therapy/.opencode/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/jank/dev/personal/git-therapy/.opencode/skills/gsd-*/`.
...
(`~/.config/opencode`), NOT the skills sub-directory (`/Users/jank/dev/personal/git-therapy/.opencode/skills`).
...
`/Users/jank/dev/personal/git-therapy/.opencode/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/Users/jank/dev/personal/git-therapy/.opencode/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/jank/dev/personal/git-therapy/.opencode/.gsd-surface.json`
Install profile marker: `/Users/jank/dev/personal/git-therapy/.opencode/.gsd-profile`
Skill dirs: `/Users/jank/dev/personal/git-therapy/.opencode/skills/gsd-*/`
Engine module: `/Users/jank/dev/personal/git-therapy/.opencode/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `/Users/jank/dev/personal/git-therapy/.opencode/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
