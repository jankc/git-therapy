...
<required_reading>
@/Users/jank/dev/personal/git-therapy/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@/Users/jank/dev/personal/git-therapy/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/jank/dev/personal/git-therapy/.claude
                  → checks /Users/jank/dev/personal/git-therapy/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/jank/dev/personal/git-therapy/.claude/get-shit-done
                  → writes to /Users/jank/dev/personal/git-therapy/.claude/get-shit-done/hooks/
...
@/Users/jank/dev/personal/git-therapy/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/Users/jank/dev/personal/git-therapy/.claude/get-shit-done/references/common-bug-patterns.md
