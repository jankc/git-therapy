...
Use template from `/Users/jank/dev/personal/git-therapy/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/jank/dev/personal/git-therapy/.claude/get-shit-done/templates/UI-SPEC.md`
