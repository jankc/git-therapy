...
```bash
INIT=$(node "/Users/jank/dev/personal/git-therapy/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/jank/dev/personal/git-therapy/.claude/get-shit-done/templates/spec.md.
