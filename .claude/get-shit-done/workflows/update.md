...
for cand in \
  ...
  "/Users/jank/dev/personal/git-therapy/.claude/get-shit-done/bin/gsd-tools.cjs"; do
...
global: `/Users/jank/dev/personal/git-therapy/.claude/`, `~/.config/opencode/`, `~/.opencode/`, `~/.gemini/`, `~/.config/kilo/`, or `~/.codex/`
