...
```markdown
Read /Users/jank/dev/personal/git-therapy/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /Users/jank/dev/personal/git-therapy/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /Users/jank/dev/personal/git-therapy/.claude/agents/gsd-ui-checker.md for instructions.
