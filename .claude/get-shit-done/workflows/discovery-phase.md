...
See /Users/jank/dev/personal/git-therapy/.claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using /Users/jank/dev/personal/git-therapy/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using /Users/jank/dev/personal/git-therapy/.claude/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from /Users/jank/dev/personal/git-therapy/.claude/get-shit-done/templates/discovery.md
...
Use /Users/jank/dev/personal/git-therapy/.claude/get-shit-done/templates/discovery.md.
