...
```bash
INIT=$(node "/Users/jank/dev/personal/git-therapy/.codex/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/jank/dev/personal/git-therapy/.codex/get-shit-done/templates/spec.md.
