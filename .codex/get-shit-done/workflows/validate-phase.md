...
```
Agent(
  prompt="Read /Users/jank/dev/personal/git-therapy/.codex/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/jank/dev/personal/git-therapy/.codex/get-shit-done/templates/VALIDATION.md`
