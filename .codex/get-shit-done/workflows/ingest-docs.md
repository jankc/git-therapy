...
```bash
INIT=$(node "/Users/jank/dev/personal/git-therapy/.codex/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/jank/dev/personal/git-therapy/.codex/get-shit-done/bin/gsd-tools.cjs" commit \
