...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/jank/dev/personal/git-therapy/.codex/.gsd-surface.json`
(sibling to `/Users/jank/dev/personal/git-therapy/.codex/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/jank/dev/personal/git-therapy/.codex/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/Users/jank/dev/personal/git-therapy/.codex/skills`).
...
`/Users/jank/dev/personal/git-therapy/.codex/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/Users/jank/dev/personal/git-therapy/.codex/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/jank/dev/personal/git-therapy/.codex/.gsd-surface.json`
Install profile marker: `/Users/jank/dev/personal/git-therapy/.codex/.gsd-profile`
Skill dirs: `/Users/jank/dev/personal/git-therapy/.codex/skills/gsd-*/`
Engine module: `/Users/jank/dev/personal/git-therapy/.codex/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `/Users/jank/dev/personal/git-therapy/.codex/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
