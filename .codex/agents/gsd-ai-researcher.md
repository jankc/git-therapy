...
<required_reading>
Read `/Users/jank/dev/personal/git-therapy/.codex/get-shit-done/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
