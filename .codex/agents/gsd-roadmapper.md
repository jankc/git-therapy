...
Reference full template: `/Users/jank/dev/personal/git-therapy/.codex/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/Users/jank/dev/personal/git-therapy/.codex/get-shit-done/templates/state.md`.
